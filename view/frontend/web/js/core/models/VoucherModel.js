...
], (CreditCardValidator, MultibuyerValidator, VoucherCardValidator, CreditCardToken) => {
   return class VoucherModel {
       ...
       validate() {
           ...
           const voucherCardValidator = new VoucherCardValidator(this.formObject);
           const isVoucherCardValid = voucherCardValidator.validate();
       ...
       getCreditCardToken(success, error) {
           ...
           let documentNumber = platFormConfig.addresses.billingAddress.vatId;
           if (typeof documentNumber === "undefined") {
               documentNumber = platFormConfig.customerData.taxvat;
           }

           const modelToken = new CreditCardToken(this.formObject, documentNumber);
